            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div class="fade-in-up space-y-6">
                    ...
                    <h1 class="text-5xl md:text-7xl font-black text-white mb-6 leading-tight text-shadow">
                        Jelajahi Masbro <span class="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-500 to-emerald-400 gradient-animate">Dunia</span><br> Per Wibuan
                    </h1>
